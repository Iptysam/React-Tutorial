...
- Type `git clone (https://github.com/Iptysam/React-Tutorial.git)` if your're using https with git or `git clone git@github.com:Iptysam/React-Tutorial.git` if your preferred is ssh and hit enter.
